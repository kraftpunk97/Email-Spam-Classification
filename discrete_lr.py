...
def main(train_path, test_path, zip_file_name):
    ...
    reg_const = learn_reg_const(train_path, model='bernoulli')

    print("Selecting {} as L2 penalty factor in a list of (0.1, 0.5, 1, 5, 10, 50, 100)".format(reg_const))
    print()
    print()

    vectorizer, w = train_lr(x_train_file_list, num_iterations=45, regularization_param=reg_const, model='bernoulli')
    ...
    print("Stats for Discrete Logistic Regression...")
